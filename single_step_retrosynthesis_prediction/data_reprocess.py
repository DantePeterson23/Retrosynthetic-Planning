...
train_data = []
for fingerprint in train_FingerPrints:
...
np.save('train_data_fin.npy', train_data)
np.save('test_data_fin.npy', test_data)
np.save('test_label_fin.npy', test_label)
np.save('train_label_fin.npy', train_label)
